        ...
        <div className="text-black p-3">
            ...
            <div className="mt-8 rounded-full">
                <div>
                    ...
                    <Modal show={visibleAdd} size="md" popup={false} onClose={() => setVisibleAdd(false)} position="top-center">
                    ...
                    <Modal show={visibleAdd2} size="mx" popup={false} onClose={() => setVisibleAdd2(false)} position="top-center">
                        <Modal.Header></Modal.Header>
                        <Modal.Body>
                            <div className="overflow-x-auto relative shadow-md md:rounded-lg">
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 md:h-auto">
                    ...
                    <Modal show={visiblecopy1} size="6xl" popup={false} onClose={() => setvisiblecopy1(false)} position="top-center">
                        <Modal.Header></Modal.Header>
                        <Modal.Body>
